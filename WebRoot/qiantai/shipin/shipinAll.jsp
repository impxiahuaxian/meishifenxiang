						    ...
						    <div class="c1-body">
                                  ...
                                  <div class="c1-bline" style="padding:7px 0px;">
                                       <div class="f-left">
                                            ...
                                            <a href="<%=path %>/shipinDetailQian.action?shipinId=<s:property value="#shipin.shipinId"/>" title=""><span style=""><s:property value="#shipin.shipinName"/></span></a>
                                       </div>
                                       <div class="f-right"><s:property value="#shipin.shijian"/></div>
                                       <div class="clear"></div>
                                  </div>
                                  </s:iterator>
								  <div class="pg-3">
